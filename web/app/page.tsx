...
export default async function HomePage() {
  ...
  if (!newsletter) {
    return (
      <main className="flex min-h-screen flex-col items-center justify-center p-8 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 text-center">
  ...
  return (
    // ADJUSTMENT 1: Increased top padding from pt-24 to pt-28
    <div className="relative max-w-4xl mx-auto p-2 sm:p-16 lg:p-16 pt-28">
      <div className="absolute inset-0 top-0 bg-grid-pattern opacity-40 pointer-events-none -z-20"></div>

      {/* ADJUSTMENT 2: Reduced bottom margin from mb-16 to mb-12 */}
      <header className="text-center pb-12 mb-0 relative">
