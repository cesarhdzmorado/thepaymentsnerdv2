    ...
    <div className="bg-slate-900 min-h-screen text-slate-300">
      <main className="container mx-auto px-4 py-16 max-w-3xl">
        <article className="prose prose-invert lg:prose-xl">
            ...
            <p>By accessing and using /thepaymentsnerd (the "Site"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use the Site.</p>
